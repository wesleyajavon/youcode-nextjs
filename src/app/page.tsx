        ...
        <div className="relative z-10 flex flex-col items-center max-w-3xl mx-auto text-center gap-6">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="font-semibold text-muted-foreground">
              {!session
                ? "+500 teachers and 1000 students trust us."
                : session.user.role === "ADMIN"
                  ? "+500 teachers trust us."
                  : "+1000 students are learning with us."}
            </p>
          </div>
          {/* AI Generator Promo */}
      ...
      <section className="bg-gradient-to-b from-primary/10 to-primary/50 py-16 text-white-foreground">
        <div className="m-auto flex max-w-5xl flex-col gap-8 px-6 md:flex-row md:gap-12">
          ...
          <div className="flex flex-1 flex-col items-center gap-3 text-center">
            ...
            <Typography variant="h3">AI-Powered Lessons</Typography>
            <Typography variant="large">
              Teachers can generate lesson content with AI in one click. Focus on teaching, let AI handle the writing!
            </Typography>
          </div>
          <div className="flex flex-1 flex-col items-center gap-3 text-center">
