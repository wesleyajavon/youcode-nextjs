    ...
    return (
        <footer className="w-full border-t border-border bg-background">
            <div className="m-auto w-full max-w-3xl px-2 py-4">
                <div className="hidden lg:flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <Typography variant="base" as={Link} href="/" className="text-lg font-bold">
                            {SiteConfig.title}
                        </Typography>
                    </div>
                
                {/* Links & Social */}
                <div className="flex flex-col items-center gap-2 text-sm text-muted-foreground lg:items-end">
                    <Link
            ...
            <div className="flex w-full items-center justify-center mt-4">
                <Typography variant="base" className="text-xs text-muted-foreground text-center">
